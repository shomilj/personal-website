...
So, naturally, I wanted to do a little bit of reverse engineering (and privacy analysis!) to see what exactly this $30M had backed! And that's exactly what I did. The rest of this article contains a walkthrough of my steps, thoughts, and takeaways from poking around BeReal using nothing more than a HTTP Request interceptor. Trivial reverse engineering, but revealing regardless.
